...
describe(StyleSelector, ()=>{
  test('renders style selector when current product & style are truthy', () => {
    ...
    const currentStyle = allProductStyles[0]
    ...
    const styleSelectorMain = screen.getByTestId('styleSelectorMain');
    expect(styleSelectorMain).toBeTruthy();
  });
})