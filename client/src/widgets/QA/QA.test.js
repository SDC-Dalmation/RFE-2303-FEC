...
// test('QA component displays one question', () => {

//   const handleClose = jest.fn();


//   const {getByText} = render(
//     <QA onClose={handleClose} productID={37311} />
//   )
